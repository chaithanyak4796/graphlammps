...
class read_structure:
        ...
        if self.use_cache:
            ...
            if not cache_exist:
                ...
                if (
                    ...
                    if self.warn_cache:
                        print(
                            " Dump cache exists, but is outdated. Will write new cache."
                        )
                    ...
                    if self.warn_cache:
                        print(
                            "Dump cache exists and is up to date. Will read the cache."
                        )
    ...
    def __read_dump_info(self):
        ...
        if line[3] == "xy":  # non-ortho box
            ...
            system.box = np.array(
                [system.xlo, system.xhi, system.ylo, system.yhi, system.zlo, system.zhi]
            )
